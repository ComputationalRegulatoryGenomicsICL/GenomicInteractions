# Capitalize first letter of string This function will capitalize the first letter of each string in a character vector, and lowercase
# following letters.  @param x A character vector @return a string with the first letter capitalised
