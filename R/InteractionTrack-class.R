...
#' elements. The value of \code{plot.outside} determines whether or not
#' interactions which span outside of the window are to be plotted, and
#' \code{col.outside} defines the colour of these interactions.
#'
#' Similarly \code{plot.trans} determines whether trans-interactions are plotted
#' and \code{col.trans} specifies the colour of trans-interactions. By default,
#' the height of an arc representing an interaction is proportional to the
#' number of reads/counts supporting that interaction. Instead of using the
#' counts to define this, the height can be set to be proportional to either
